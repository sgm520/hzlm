...
class Ajax extends Backend
{
    ...
    public function articlecategory(){
        $categorylist = Db::name('article_category')->where('status',1)->field('name as id ,name')->select();
        return $categorylist;
    }

    public function fangyong(){
        $categorylist = Db::name('fanyong')->field('name as id ,name')->select();
        return $categorylist;
    }
    ...
    public function chaoshicategory(){
        $categorylist = Db::name('chaoshi_category')->field('name as id ,name')->select();
        return $categorylist;
    }

    public function group(){
        $categorylist = Db::name('caoshi_group')->field('name as id ,name')->select();
        return $categorylist;
    }

    public function bq(){
        $categorylist = Db::name('label')->field('name as id ,name')->select();
        return $categorylist;
    }
}
